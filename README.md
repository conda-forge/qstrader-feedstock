...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qstrader-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11812&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qstrader-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qstrader` can be installed with:

```
conda install qstrader
```

It is possible to list all of the versions of `qstrader` available on your platform with:
